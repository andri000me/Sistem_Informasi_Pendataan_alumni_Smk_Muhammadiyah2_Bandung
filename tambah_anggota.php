					...
					<div class="panel-body">
						...
						<form action="proses.php" method="post" enctype="multipart/form-data">
										...
										<div class="col-sm-10 form-horizontal">
											...
											<div class="form-group">
												...
												<div class="col-lg-8 col-md-8 col-sm-6">
													<input type="text" name="nis" id="nis" required class="form-control" placeholder="Nomor Induk Siswa">
												</div>
											</div>
											<!-- Nama Lengkap -->
											<div class="form-group">
									...
									<div class="container">
										<div class="col-sm-10 form-horizontal">
											...
											<div class="form-group">
												...
												<div class="col-lg-8 col-md-8 col-sm-6">
													<input type="text" name="nama_ptn" id="nama_ptn" class="form-control" placeholder="Nama Perguruan Tinggi">
												</div>
											</div>
											<div class="form-group">
												<label class="col-lg-3 col-md-3 col-sm-5 control-label">
												...
												<div class="col-lg-8 col-md-8 col-sm-6">
													<input type="text" name="program_std" id="program_std" class="form-control" placeholder="Program Studi">
												</div>
											</div>
											<div class="form-group">
												<label class="col-lg-3 col-md-3 col-sm-5 control-label">
											...
											<div class="form-group">
												...
												<div class="col-lg-8 col-md-8 col-sm-6">
													<input type="text" name="nama_wrs" id="nama_wrs" class="form-control" placeholder="Nama Wirausaha">
												</div>
											</div>
											<div class="form-group">
												<label class="col-lg-3 col-md-3 col-sm-5 control-label">
												...
												<div class="col-lg-8 col-md-8 col-sm-6">
													<input type="text" name="jenis_usaha" id="jenis_usaha" class="form-control" placeholder="Jenis Usaha">
												</div>
											</div>
											<div class="form-group">
												<label class="col-lg-3 col-md-3 col-sm-5 control-label">
												...
												<div class="col-lg-8 col-md-8 col-sm-6">
													<input type="text" name="alamat_usaha" id="alamat_usaha" class="form-control" placeholder="Alamat Usaha">
												</div>
											</div>
										</div>
									</div>
											...
											<div class="form-group">
												...
												<div class="col-lg-5 col-md-5 col-sm-4">
													<select data-toggle="select" name="pk" id="pk" class="form-control select select-primary mrs mbm">
														...
														<?php 
															// Ambil data kota dari tabel master kota
															$daftar_pk = ambil_data_global("aluni_program_keahlian", "kode_pk, pk, deskripsi");
															$select_pk = "";
															foreach ($daftar_pk as $dpk) {
																$select_pk .= "<option value='$dpk[pk]'>($dpk[pk]) $dpk[deskripsi]</option>";
															}
															echo $select_pk;
														?>
													</select>
							...
							<div class="well text-center">
								<button type="submit" class="btn btn-primary btn-lg" id="proses_simpan">Simpan&nbsp;<span class="glyphicon glyphicon-save"></span></button>
							</div>
						</form>
					</div>
				</div>
