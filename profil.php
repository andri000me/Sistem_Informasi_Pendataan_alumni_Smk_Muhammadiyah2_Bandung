					...
					<div class="panel-body">
						...
						<div class="form-horizontal">
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal_dialog_ubah_password">Ubah Password &nbsp;<span class="glyphicon glyphicon-edit"></span></button>
								</div>
							</div>
						</div>
					</div>
