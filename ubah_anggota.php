...
if (sudah_login() && (strpos($_SESSION['a2_hak_akses'], '003')!==FALSE || $_SESSION['a2_hak_akses']=="*")) {
	...
	$datas      = ambil_data_global("aluni_v_anggota_mentah a, aluni_anggota_akademik b, aluni_anggota_terkini c", "*", " a.id_anggota=b.id_anggota AND c.id_anggota=a.id_anggota AND a.id_anggota='$id_anggota'", "a.nama_lengkap ASC");
	foreach ($datas as $data) {
		...
		// Data Terkini
		$posisi         = $data["posisi"];
		$alamat_prsh    = $data["alamat_perusahaan"];
		$nama_ptn       = $data["nama_ptn"];
		$program_std    = $data["program_std"];
		$jurusan    	= $data["jurusan"];
		$nama_wrs       = $data["nama_usaha"];
					...
					<div class="panel-body">
						...
						<form action="proses.php" method="post" enctype="multipart/form-data">
							...
							<ul class="nav nav-tabs" role="tablist">
								...
								<li role="presentation">
									<a href="#recent_info" aria-controls="academic_info" role="tab" data-toggle="tab"><i class="glyphicon glyphicon-user"></i> Data Terkini</a>
								</li>
								<li role="presentation">
							...
							<div class="tab-content">
										...
										<div class="col-sm-10 form-horizontal">
											...
											<div class="form-group">
												...
												<div class="col-lg-8 col-md-8 col-sm-6">
													<input type="text" name="nis" id="nis" required class="form-control" placeholder="Nomor Induk Siswa" onchange="auto_nickname(this.value)" value="<?php echo $nis ?>">
								...
								<!-- Informasi Terkini -->
								<div role="tabpanel" class="tab-pane" id="recent_info">
									<div class="container">
										<div class="col-sm-10 form-horizontal">
											<br>
											<!-- Pekerjaan -->
											<div class="form-group">
												...
												<div class="col-lg-8 col-md-8 col-sm-6">
													<input type="text" name="posisi" id="posisi" class="form-control" placeholder="Posisi" value="<?php echo $posisi ?>">
												</div>
											</div>
											<div class="form-group">
												<label class="col-lg-3 col-md-3 col-sm-5 control-label">
												...
												<div class="col-lg-8 col-md-8 col-sm-6">
													<input type="text" name="alamat_perusahaan" id="alamat_perusahaan" class="form-control" placeholder="Alamat Perusahaan" value="<?php echo $alamat_usaha ?>">
												</div>
											</div>
											<hr>
											<!-- Kuliah -->
											<div class="form-group">
												...
												<div class="col-lg-8 col-md-8 col-sm-6">
													<input type="text" name="nama_ptn" id="nama_ptn" class="form-control" placeholder="Nama Perguruan Tinggi" value="<?php echo $nama_ptn ?>">
												</div>
											</div>
											<div class="form-group">
												<label class="col-lg-3 col-md-3 col-sm-5 control-label">
												...
												<div class="col-lg-8 col-md-8 col-sm-6">
													<input type="text" name="program_std" id="program_std" class="form-control" placeholder="Program Studi" value="<?php echo $program_std ?>">
												</div>
											</div>
											<div class="form-group">
												<label class="col-lg-3 col-md-3 col-sm-5 control-label">
												...
												<div class="col-lg-8 col-md-8 col-sm-6">
													<input type="text" name="jurusan" id="jurusan" class="form-control" placeholder="Jurusan" value="<?php echo $jurusan ?>">
												</div>
											</div>
											<hr>
											<!-- Wirausaha -->
											<div class="form-group">
												...
												<div class="col-lg-8 col-md-8 col-sm-6">
													<input type="text" name="nama_wrs" id="nama_wrs" class="form-control" placeholder="Nama Wirausaha" value="<?php echo $nama_wrs ?>">
												</div>
											</div>
											<div class="form-group">
												<label class="col-lg-3 col-md-3 col-sm-5 control-label">
												...
												<div class="col-lg-8 col-md-8 col-sm-6">
													<input type="text" name="jenis_usaha" id="jenis_usaha" class="form-control" placeholder="Jenis Usaha" value="<?php echo $jenis_usaha ?>">
												</div>
											</div>
											<div class="form-group">
												<label class="col-lg-3 col-md-3 col-sm-5 control-label">
												...
												<div class="col-lg-8 col-md-8 col-sm-6">
													<input type="text" name="alamat_usaha" id="alamat_usaha" class="form-control" placeholder="Alamat Usaha" value="<?php echo $alamat_usaha ?>">
												</div>
											</div>
										</div>
									</div>
									...
									<div class="container">
										<div class="col-sm-10 form-horizontal">
											...
											<div class="form-group">
												...
												<div class="col-lg-5 col-md-5 col-sm-4">
													<select data-toggle="select" name="pk" id="pk" class="form-control select select-primary mrs mbm">
														<option value="">- Pilih Program Keahlian -</option>
														<?php 
															$daftar_pk = ambil_data_global("aluni_program_keahlian", "*");
															$select_pk = "";
															foreach ($daftar_pk as $dpk) {
																if ($dpk["pk"]==$pk) {
																	$select_pk .= "<option value='$dpk[pk]' selected>$dpk[deskripsi]</option>";
																}
																else {
																	$select_pk .= "<option value='$dpk[pk]'>$dpk[deskripsi]</option>";
																}
															}
															echo $select_pk;
														?>
													...
													<script type="text/javascript">
														$(document).ready(function() {
															$('select[name="pk"]').select2({dropdownCssClass: 'show-select-search'});
														});
													</script>
											</div>
											<hr>
							...
							<div class="well text-center">
								<button type="submit" class="btn btn-primary btn-lg" id="proses_simpan">Rubah&nbsp;<span class="glyphicon glyphicon-edit"></span></button>
							</div>
						</form>
					</div>
				</div>
