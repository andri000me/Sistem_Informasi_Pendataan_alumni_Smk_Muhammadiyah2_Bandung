...
if (sudah_login()) {
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
				<div class="panel panel-default">
					<div class="panel-body">
						<legend>Daftar Alumni</legend>
						<?php 
							$daftar_anggota = ambil_data_global("aluni_v_anggota_lengkap a, aluni_anggota_akademik b, aluni_anggota_terkini c", "*", " a.id_anggota=b.id_anggota AND c.id_anggota=a.id_anggota", "a.nama_lengkap ASC");
									...
									<?php 
										...
										foreach ($daftar_anggota as $data) {
											...
											<tr>
												...
												<td><?php echo $data["kode_pk"]; ?></td>
												<!-- <td>Aksinya</td> -->
												<?php if (sudah_login()): ?>
												<input type="hidden" id="nis_<?php echo $data["id_anggota"]; ?>" value="<?php echo $data["nis"]; ?>">
												<input type="hidden" id="program_keahlian_<?php echo $data["id_anggota"]; ?>" value="<?php echo $data["kode_pk"]; ?>">
												...
												<input type="hidden" id="posisi_<?php echo $data["id_anggota"]; ?>" value="<?php echo $data["posisi"]; ?>">
												<input type="hidden" id="alamat_perusahaan_<?php echo $data["id_anggota"]; ?>" value="<?php echo $data["alamat_perusahaan"]; ?>">
												<input type="hidden" id="nama_ptn_<?php echo $data["id_anggota"]; ?>" value="<?php echo $data["nama_ptn"]; ?>">
												<input type="hidden" id="program_std_<?php echo $data["id_anggota"]; ?>" value="<?php echo $data["program_std"]; ?>">
												<input type="hidden" id="jurusan_<?php echo $data["id_anggota"]; ?>" value="<?php echo $data["jurusan"]; ?>">
												<input type="hidden" id="nama_wrs_<?php echo $data["id_anggota"]; ?>" value="<?php echo $data["nama_usaha"]; ?>">
												<input type="hidden" id="jenis_usaha_<?php echo $data["id_anggota"]; ?>" value="<?php echo $data["jenis_usaha"]; ?>">
												<input type="hidden" id="alamat_usaha_<?php echo $data["id_anggota"]; ?>" value="<?php echo $data["alamat_usaha"]; ?>">
												<td>
													<button type="button" class="btn btn-inverse btn-sm" onclick="tampil_detail_anggota(<?php echo $data["id_anggota"]; ?>)"><span class="glyphicon glyphicon-search"></span></button><br>
													<?php if (strpos($_SESSION['a2_hak_akses'], 'null')!==FALSE || $_SESSION['a2_hak_akses']=="*"): ?>
													<a href="ubah_anggota.php?ida=<?php echo $data["id_anggota"].hash("md5", rand()); ?>" class="btn btn-sm btn-primary"><span class="glyphicon glyphicon-edit"></span></a>
													
													<form action="proses.php" method="post">
														<input type="hidden" name="aksi" value="hapus_anggota"><input type="hidden" name="id_anggota" value="<?php echo $data["id_anggota"] ?>"><button type="submit" class="btn btn-sm btn-danger" onclick="return confirm('Yakin hapus data pengguna? Pengguna ini akan dihapus dan tidak dapat dikembalikan.')"><span class="glyphicon glyphicon-trash"></button>
													</form>
													<?php endif ?>
												</td>
												<?php endif ?>
	    ...
	    <div class="modal-dialog modal-lg">
	        <div class="modal-content">
	            <div class="modal-header">
	                ...
	                <h4 class="modal-title" id="modal_title_anggota_detail">Detail Alumni</h4>
	            </div>
	            <div class="modal-body form-horizontal" id="modal_content_anggota_detail">
					...
					<div class="form-group">
	                    ...
	                    <div class="col-sm-8 form-control-static" id="md_nis"></div>
	                </div>
					<div class="form-group">
	                ...
	                <div class="form-group">
	                    <label class="control-label col-sm-3">Program Keahlian :</label>
	                    <div class="col-sm-8 form-control-static" id="md_program_keahlian"></div>
	                </div>
	                <div class="form-group">
	                ...
	                <hr class="dashed">
					<legend class="text-center">Data Terkini</legend>
					<div class="form-group">
	                    <label class="control-label col-sm-3">Posisi :</label>
	                    <div class="col-sm-8 form-control-static" id="md_posisi"></div>
	                </div>
					<div class="form-group">
	                    <label class="control-label col-sm-3">Alamat Perusahaan :</label>
	                    <div class="col-sm-8 form-control-static" id="md_alamat_perusahaan"></div>
	                </div>
	                <div class="form-group">
	                    <label class="control-label col-sm-3">Universitas :</label>
	                    <div class="col-sm-8 form-control-static" id="md_nama_ptn"></div>
	                </div>
	                <div class="form-group">
	                    <label class="control-label col-sm-3">Program Studi :</label>
	                    <div class="col-sm-8 form-control-static" id="md_program_std"></div>
	                </div>
	                <div class="form-group">
	                    <label class="control-label col-sm-3">Jurusan :</label>
	                    <div class="col-sm-8 form-control-static" id="md_jurusan"></div>
	                </div>
	                <div class="form-group">
	                    <label class="control-label col-sm-3">Nama Usaha :</label>
	                    <div class="col-sm-8 form-control-static" id="md_nama_wrs"></div>
	                </div>
	                <div class="form-group">
	                    <label class="control-label col-sm-3">Jenis Usaha :</label>
	                    <div class="col-sm-8 form-control-static" id="md_jenis_usaha"></div>
	                </div>
	                <div class="form-group">
	                    <label class="control-label col-sm-3">Alamat Usaha :</label>
	                    <div class="col-sm-8 form-control-static" id="md_alamat_usaha"></div>
	                </div>
	...
	<script type="text/javascript">
		...
		function tampil_detail_anggota (id_anggota) {
			...
			// Set hasil akademik
			$("#md_nis").html($("#nis_"+id_anggota).val());
			$("#md_angkatan").html($("#angkatan_"+id_anggota).val());
			$("#md_program_keahlian").html($("#program_keahlian_"+id_anggota).val());
			...
			// Set hasil Terkni
			$("#md_posisi").html($("#posisi_"+id_anggota).val());
			$("#md_alamat_perusahaan").html($("#alamat_perusahaan_"+id_anggota).val());
			$("#md_nama_ptn").html($("#nama_ptn_"+id_anggota).val());
			$("#md_jurusan").html($("#jurusan_"+id_anggota).val());
			$("#md_program_std").html($("#program_std_"+id_anggota).val());
			$("#md_nama_wrs").html($("#nama_wrs_"+id_anggota).val());
			$("#md_jenis_usaha").html($("#jenis_usaha_"+id_anggota).val());
			$("#md_alamat_usaha").html($("#alamat_usaha_"+id_anggota).val());
