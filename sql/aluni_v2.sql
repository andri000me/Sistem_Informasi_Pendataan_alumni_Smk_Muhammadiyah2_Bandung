...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 25, 2020 at 06:30 AM
...
INSERT INTO `aluni_anggota_akademik` (`id_anggota`, `nis`, `angkatan`, `tahun_masuk`, `tahun_keluar`, `kelas_terakhir`, `kode_pk`, `catatan`, `created_by`, `created_date`, `updated_by`, `updated_date`, `revisi`) VALUES
(1, '', '', 0, 0, '', '0', '', 'admin', '2017-02-17 10:43:52', 'admin', '2017-02-17 11:05:07', 1),
(2, '', '13', 1343, 1333, '1313', 'TKJ', '<p>sdfsfd</p>', 'admin', '2019-07-21 21:33:53', 'admin', '2019-07-21 21:33:53', 0),
(5, '1617.10.154', '2016', 2016, 2018, '11', 'RPL', '<p>LULUS</p>', 'admin', '2020-06-14 19:01:28', 'admin', '2020-06-14 19:01:28', 0),
(6, '1617.10.032', '2016', 2016, 2018, '11', 'PBS', '<p>LULUS</p>', 'admin', '2020-06-14 19:04:34', 'admin', '2020-06-14 19:04:34', 0),
(7, '1617.10.156', '2016', 2016, 2018, '11', 'ADM', '<p>Lulus</p>', 'admin', '2020-06-14 19:08:26', 'admin', '2020-06-14 19:08:26', 0),
(9, '1617.10.155', '2016', 2016, 2018, '11', 'RPL', '<p>Lulus</p>', 'admin', '2020-06-14 19:15:05', 'admin', '2020-06-14 19:15:05', 0),
(11, '1617.10.159', '13', 1990, 1993, 'XI-ADM', 'ADM', '', 'admin', '2020-06-27 20:24:39', 'admin', '2020-06-27 20:24:39', 0),
(12, '1617.10.157', '2016', 2016, 2019, '11', 'TSP', '<p>LULUS</p>', 'admin', '2020-08-31 07:04:02', 'admin', '2020-08-31 07:04:02', 0);
...
(1, 'Sedotcode.blogspot.com', 'sedotcode', 'laki-laki', 'Kota Sabang', '2017-02-16', '1', 0x7365646f74636f64652e6a7067, 1, 3, '<p>Jalan t<strong>erus jadian kapan</strong></p>', 'ya', 'admin', '2017-02-17 10:43:52', 'admin', '2017-02-17 11:05:07', 1),
(5, 'Adi Muhamad Malik', 'adimm', 'laki-laki', 'Kota Bandung', '0000-00-00', '1', 0x6e6f2d696d672e6a7067, 12, 0, '<p>Kp. Babakan Salam</p>', 'ya', 'admin', '2020-06-14 19:01:27', 'admin', '2020-06-14 19:01:27', 0),
(6, 'Wahyudin', 'wahyudin', 'laki-laki', 'Kota Bandung', '2000-07-11', '1', 0x6e6f2d696d672e6a7067, 0, 0, '<p>Jl. Manisi Kp. Sukasari</p>', 'ya', 'admin', '2020-06-14 19:04:33', 'admin', '2020-06-14 19:04:33', 0),
(7, 'Aisha Nur Hasya', 'aishanh', 'perempuan', 'Kota Bandung', '2020-06-23', '1', 0x6e6f2d696d672e6a7067, 12, 0, '<p>Komp. Griya Wiyana Blok B 15 A&nbsp;</p>', 'ya', 'admin', '2020-06-14 19:08:25', 'admin', '2020-06-14 19:08:25', 0),
(9, 'Aini Dinah Umaroh', 'ainido', 'perempuan', 'Kota Bandung', '2000-03-13', '1', 0x6e6f2d696d672e6a7067, 12, 177, '<p>Kp. Mekarsari Cilengkrang II</p>', 'ya', 'admin', '2020-06-14 19:15:04', 'admin', '2020-06-14 19:15:04', 0),
(11, 'Angela Lee', 'Ailee', 'perempuan', 'Kota Langsa', '2020-06-04', '2', 0x6e6f2d696d672e6a7067, 14, 193, '<p>Seoul</p>', 'ya', 'admin', '2020-06-27 20:24:39', 'admin', '2020-06-27 20:24:39', 0),
(12, 'Wahyu Serikan', 'wahyus', 'laki-laki', 'Kabupaten Bandung', '0000-00-00', '1', 0x6e6f2d696d672e6a7067, 12, 0, '<p>Jalan Cipadung No 12 Rt/rw 01/02</p>', 'ya', 'admin', '2020-08-31 07:04:01', 'admin', '2020-08-31 07:04:01', 0);
...
(1, '', '', 'admin', '2017-02-17 10:43:52', 'admin', '2017-02-17 11:05:07', 1),
(2, 'fds', 'asdas', 'admin', '2019-07-21 21:33:53', 'admin', '2019-07-21 21:33:53', 0),
(5, '', '', 'admin', '2020-06-14 19:01:28', 'admin', '2020-06-14 19:01:28', 0),
(6, '', '', 'admin', '2020-06-14 19:04:34', 'admin', '2020-06-14 19:04:34', 0),
(7, '', '', 'admin', '2020-06-14 19:08:25', 'admin', '2020-06-14 19:08:25', 0),
(9, '', '', 'admin', '2020-06-14 19:15:05', 'admin', '2020-06-14 19:15:05', 0),
(11, '', '', 'admin', '2020-06-27 20:24:39', 'admin', '2020-06-27 20:24:39', 0),
(12, 'Neni agust', 'Remi', 'admin', '2020-08-31 07:04:02', 'admin', '2020-08-31 07:04:02', 0);
...
(1, '', '', '', '', '', 'http://sedotcode.blogspot.co.id/', '', '', 'admin', '2017-02-17 10:43:52', 'admin', '2017-02-17 11:05:07', 1),
(2, '86', '5674456', '456456', 'dft643', 'dfgd@yahoo.com', 'www.jsadf.com', 'http://facebook.com/aluni_v2', '@dfsfds', 'admin', '2019-07-21 21:33:53', 'admin', '2019-07-21 21:33:53', 0),
(5, '', '', '', '', '', '', '', '', 'admin', '2020-06-14 19:01:28', 'admin', '2020-06-14 19:01:28', 0),
(6, '', '', '', '', '', '', '', '', 'admin', '2020-06-14 19:04:34', 'admin', '2020-06-14 19:04:34', 0),
(7, '', '', '', '', '', '', '', '', 'admin', '2020-06-14 19:08:25', 'admin', '2020-06-14 19:08:25', 0),
(9, '', '', '', '', '', '', '', '', 'admin', '2020-06-14 19:15:05', 'admin', '2020-06-14 19:15:05', 0),
(11, '', '', '', '', '', '', '', '', 'admin', '2020-06-27 20:24:39', 'admin', '2020-06-27 20:24:39', 0),
(12, '', '', '', '', '', '', '', '', 'admin', '2020-08-31 07:04:02', 'admin', '2020-08-31 07:04:02', 0);
...
(1, '', '', '', 0, 0, '', 'admin', '2017-02-17 10:43:52', 'admin', '2017-02-17 11:05:07', 1),
(2, 'asd', 'asd', 'asd', 2, 25, '<p>asdasd</p>', 'admin', '2019-07-21 21:33:53', 'admin', '2019-07-21 21:33:53', 0),
(5, 'Jajang Elang Sobana', 'Yati Karyati', '', 12, 0, '<p>Kp. Babakan Salam</p>', 'admin', '2020-06-14 19:01:28', 'admin', '2020-06-14 19:01:28', 0),
(6, 'Agus Tantang', 'Lina', '', 0, 0, '<p>Jl. Manisi Kp. Sukasari</p>', 'admin', '2020-06-14 19:04:34', 'admin', '2020-06-14 19:04:34', 0),
(7, 'Asep M', 'Rini R', '', 12, 177, '<p>Komp. Griya Wiyana Blok B 15 A&nbsp;</p>', 'admin', '2020-06-14 19:08:25', 'admin', '2020-06-14 19:08:25', 0),
(9, 'Amiruddin Pranawijaya', 'Wawang Rusmiati', '', 12, 177, '<p>Kp. Mekarsari Cilengkrang II</p>', 'admin', '2020-06-14 19:15:05', 'admin', '2020-06-14 19:15:05', 0),
(11, 'Hyung', 'Oemma', '', 2, 0, '', 'admin', '2020-06-27 20:24:39', 'admin', '2020-06-27 20:24:39', 0),
(12, 'Agus Mind', 'Elis Rahwati', '', 6, 0, '<p>Jalan Cipadung No 12</p>', 'admin', '2020-08-31 07:04:02', 'admin', '2020-08-31 07:04:02', 0);

-- --------------------------------------------------------

--
-- Table structure for table `aluni_anggota_terkini`
--

CREATE TABLE IF NOT EXISTS `aluni_anggota_terkini` (
  `id_anggota` int(11) NOT NULL,
  `posisi` varchar(26) NOT NULL,
  `alamat_perusahaan` text NOT NULL,
  `nama_ptn` varchar(50) NOT NULL,
  `program_std` varchar(52) NOT NULL,
  `jurusan` varchar(52) NOT NULL,
  `nama_usaha` varchar(52) NOT NULL,
  `jenis_usaha` varchar(52) NOT NULL,
  `alamat_usaha` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `aluni_anggota_terkini`
--

INSERT INTO `aluni_anggota_terkini` (`id_anggota`, `posisi`, `alamat_perusahaan`, `nama_ptn`, `program_std`, `jurusan`, `nama_usaha`, `jenis_usaha`, `alamat_usaha`) VALUES
(5, '', '', '', '', '', '', '', ''),
(6, '', '', '', '', '', '', '', ''),
(7, '', '', '', '', '', '', '', ''),
(9, '', '', '', '', '', '', '', ''),
(11, 'CEO Rocket Ent', 'Seoul', '', '', '', '', '', ''),
(12, 'PT Cahya ', '', '', '', '', '', '', '');

-- --------------------------------------------------------

--
-- Stand-in structure for view `aluni_data_view`
--
CREATE TABLE IF NOT EXISTS `aluni_data_view` (
`id_anggota` int(12)
...
(003, 'Tambah Alumni', 'tambah_anggota.php', 'Tambah & Edit data anggota', 'biasa', 'ya', '2016-01-28 09:39:25'),
(004, 'Laporan', 'laporan.php', 'Pembuatan laporan', 'biasa', 'ya', '2016-01-28 09:39:52'),
(005, 'Program Keahlian', 'program_keahlian.php', 'manajemen program keahlian', 'biasa', 'ya', '2019-07-21 00:00:00');
...
(1, 'nama_sistem', 'Sistem Informasi Alumni SMK Muhammadiyah 2 Cibiru', 'ya', 'Nama instansi pengguna', '2016-01-20 14:57:58'),
(2, 'lokasi_sistem', '<p>Jalan Cibiru</p>', 'ya', 'Lokasi instansi pengguna sistem', '2016-01-20 15:03:35'),
(3, 'keterangan_sistem', '<p>Sebuah aplikasi yang digunakan untuk mengatur data alumni SMK Muhammadiyah 2 Cibiru. Anda dapat membuat laporan dari data alumni yang telah ada di dalam database.</p>', 'ya', 'Keterangan sistem', '2016-01-28 09:06:29');
...
('adimm', 'c6a1006581c2be37bbbb98bc34fbae36abf6dd34ada75402dfd26ac09df0d5c5569aabd2b137d3bef627e4568f70f1e6d15c177942d672810d90df928684cc22', 'f8eea2afc4fccdb3d97fc610bf203aade86acdf2f478469b0305e6f3e4e6ccb0', 'user', 'ya', 'Adi Muhamad Malik', '', 'no-img.jpg', 5, 'admin', '2020-06-14 19:01:27', 'admin', '2020-06-14 19:01:27', 0),
...
('ailee', 'd1b21aff4d0099f9d08452d8e75025128bab235c9b2b69fe8a739457732554282787ff471f50f0293fe8538a20e6da05d7b034014e10cf3da8ee8f1b102d5fe9', '7f3ee9fe1fbf452b0c242614e1cad18b6dce034e5bc80763dff6332e872ad2ff', 'user', 'ya', 'Angela Lee', '', 'no-img.jpg', 11, 'admin', '2020-06-27 20:24:39', 'admin', '2020-06-27 20:24:39', 0),
('ainido', 'ba17c4589968798adcfcc25bad76ea9a931dbedbf3ac8cbc76186d83cadeeb4f7d4f772c717ebbbdee7d50babaca4354c20c7c434d956e15a9b1a496d2da0071', '62decb829d0c54c04597ba9fbdbaf7d3b598779ef37269bff21fe1f4f2edc593', 'user', 'ya', 'Aini Dinah Umaroh', '', 'no-img.jpg', 9, 'admin', '2020-06-14 19:15:05', 'admin', '2020-06-14 19:15:05', 0),
('ainidu', '8b4471ff7300ea94babf095f6048f7294bb560df519aa3d5999d54012a6ea361ffdaa8adce5a3fbe192b76f790d5d2747adf44f351ca1ce0f4137ec9c5569077', '062d1147a84463e07663fd6e18ecc1dc5eba5682b180c50a7a3fa4ee57eedaf0', 'user', 'ya', 'Aini Dinah Umaroh', '', 'no-img.jpg', 8, 'admin', '2020-06-14 19:11:42', 'admin', '2020-06-14 19:11:42', 0),
('aishanh', 'cb2b9184939f57898980e441bf670d14841ec392ae427d2f2427c38b416874a872e1adefa662771adbb544ea085aa45b34c50090ab6efa04a681f5cf275ac2f0', '3fbc67316c26f1491f9a6e9a836aad0b866b86ed24562f910aec234032499a66', 'user', 'ya', 'Aisha Nur Hasya', '', 'no-img.jpg', 7, 'admin', '2020-06-14 19:08:25', 'admin', '2020-06-14 19:08:25', 0),
('sedotcode', 'a99f3ea53ec8cb8b648a2e4ae4e5a3f66fb6745b8ef1de1661605a6f5ecb10aca65da4acc2b664fbc269eda43555b29d07b6b451efb56a796b96a7a4997138e5', '83545a4189515cfe34f2e3637e192b7aba3d4ce77a7659be21c2e82d6b23742c', 'user', 'ya', 'Sedotcode.blogspot.com', '', 'sedotcode.jpg', 1, 'admin', '2017-02-17 10:43:52', 'admin', '2017-02-17 11:05:07', 1),
('wahyudin', '3c4f323be446515c21d1e1c4a99db56f8eb390ea20d7039dab54b1701fe998fa5c12b44e445d771d188df4f0384f0cfca4b74bb7579348170bdd14d361154782', 'cfec643874bee47476d6a925656d0dd1492124809ed410ec814b36e4576c8d4c', 'user', 'ya', 'Wahyudin', '', 'no-img.jpg', 6, 'admin', '2020-06-14 19:04:33', 'admin', '2020-06-14 19:04:33', 0),
('wahyus', '540298fdf6b3983ffd4c7963e68d2fb42c7ac4a41bdaa146a740061449fa50695f6193ed47548198c65025ade500f47bb7e4746013f20238717b109b5277c34a', '067826daa0e584cc9d0fe052d6a6442a446cf614bb7dc95751ca16292df8ad48', 'user', 'ya', 'Wahyu Serikan', '', 'no-img.jpg', 12, 'admin', '2020-08-31 07:04:02', 'admin', '2020-08-31 07:04:02', 0);
...
('adimm', '', '2020-06-14 19:01:27'),
('admin', '*', '2016-01-28 10:04:05'),
('ailee', '', '2020-06-27 20:24:39'),
('ainido', '', '2020-06-14 19:15:05'),
('ainidu', '', '2020-06-14 19:11:42'),
('aishanh', '', '2020-06-14 19:08:25'),
('wahyudin', '', '2020-06-14 19:04:33'),
('wahyus', '', '2020-08-31 07:04:02');
...
(5, 'adimm', '12fd7aef', 'belum diubah', 'admin', '2020-06-14 19:01:28', 'admin', '2020-06-14 19:01:28'),
(6, 'wahyudin', 'ca0ac344', 'belum diubah', 'admin', '2020-06-14 19:04:33', 'admin', '2020-06-14 19:04:33'),
(7, 'aishanh', '360680bc', 'belum diubah', 'admin', '2020-06-14 19:08:25', 'admin', '2020-06-14 19:08:25'),
(8, 'ainidu', 'f0d5822f', 'belum diubah', 'admin', '2020-06-14 19:11:42', 'admin', '2020-06-14 19:11:42'),
(9, 'ainido', '9e8a2a74', 'belum diubah', 'admin', '2020-06-14 19:15:05', 'admin', '2020-06-14 19:15:05'),
(11, 'ailee', 'ailee12345', 'belum diubah', 'admin', '2020-06-27 20:24:39', 'admin', '2020-06-27 20:24:39'),
(12, 'wahyus', '597180d3', 'belum diubah', 'admin', '2020-08-31 07:04:02', 'admin', '2020-08-31 07:04:02');

-- --------------------------------------------------------

--
-- Table structure for table `aluni_program_keahlian`
--

CREATE TABLE IF NOT EXISTS `aluni_program_keahlian` (
...
--
-- Dumping data for table `aluni_program_keahlian`
--

INSERT INTO `aluni_program_keahlian` (`kode_pk`, `pk`, `deskripsi`) VALUES
(4, 'ADM', 'Administrasi'),
(5, 'RPL', 'Rekayasa Perangkat Lunak'),
(6, 'TKJ', 'Teknik Komputer Jaringan'),
(7, 'TSP', 'Teknik Sepeda Motor'),
(8, 'PBS', 'Perbankan Syariah');
...
--
-- Stand-in structure for view `aluni_v_data`
--
CREATE TABLE IF NOT EXISTS `aluni_v_data` (
`nama_lengkap` varchar(100)
,`nama_panggilan` varchar(50)
,`jenis_kelamin` enum('laki-laki','perempuan')
,`tanggal_lahir` date
...
--
-- Structure for view `aluni_data_view`
--
DROP TABLE IF EXISTS `aluni_data_view`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `aluni_data_view` AS select `a`.`id_anggota` AS `id_anggota`,`a`.`nama_lengkap` AS `nama_lengkap`,`a`.`nama_panggilan` AS `nama_panggilan`,`a`.`jenis_kelamin` AS `jenis_kelamin`,`a`.`tempat_lahir` AS `tempat_lahir`,`a`.`tanggal_lahir` AS `tanggal_lahir`,`a`.`agama` AS `agama`,`a`.`foto` AS `foto`,`a`.`provinsi` AS `provinsi`,`a`.`kota` AS `kota`,`a`.`alamat` AS `alamat`,`a`.`aktif` AS `aktif`,`a`.`angkatan` AS `angkatan`,`a`.`tahun_masuk` AS `tahun_masuk`,`a`.`tahun_keluar` AS `tahun_keluar`,`a`.`kelas_terakhir` AS `kelas_terakhir`,`a`.`catatan` AS `catatan`,`a`.`nama_pasangan` AS `nama_pasangan`,`a`.`nama_anak` AS `nama_anak`,`a`.`nama_ayah` AS `nama_ayah`,`a`.`nama_ibu` AS `nama_ibu`,`a`.`nama_wali` AS `nama_wali`,`a`.`provinsi_orang_tua` AS `provinsi_orang_tua`,`a`.`kota_orang_tua` AS `kota_orang_tua`,`a`.`alamat_orang_tua` AS `alamat_orang_tua`,`a`.`no_rumah` AS `no_rumah`,`a`.`no_handphone` AS `no_handphone`,`a`.`no_handphone2` AS `no_handphone2`,`a`.`pin_blackberry` AS `pin_blackberry`,`a`.`alamat_email` AS `alamat_email`,`a`.`alamat_website` AS `alamat_website`,`a`.`facebook` AS `facebook`,`a`.`twitter` AS `twitter`,`b`.`kode_pk` AS `kode_pk` from (`aluni_v_anggota_lengkap` `a` join `aluni_anggota_akademik` `b`) where (`a`.`id_anggota` = `b`.`id_anggota`);
...
--
-- Structure for view `aluni_v_data`
--
DROP TABLE IF EXISTS `aluni_v_data`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `aluni_v_data` AS select `b`.`nama_lengkap` AS `nama_lengkap`,`b`.`nama_panggilan` AS `nama_panggilan`,`b`.`jenis_kelamin` AS `jenis_kelamin`,`b`.`tanggal_lahir` AS `tanggal_lahir`,`b`.`alamat` AS `alamat`,`c`.`angkatan` AS `angkatan`,`c`.`kode_pk` AS `kode_pk` from ((`aluni_program_keahlian` `a` join `aluni_anggota_dasar` `b`) join `aluni_anggota_akademik` `c`) where ((`a`.`pk` = `c`.`kode_pk`) and (`b`.`id_anggota` = `c`.`id_anggota`));
...
--
-- Indexes for table `aluni_anggota_terkini`
--
ALTER TABLE `aluni_anggota_terkini`
 ADD PRIMARY KEY (`id_anggota`);
...
--
-- Indexes for table `aluni_program_keahlian`
--
ALTER TABLE `aluni_program_keahlian`
...
--
ALTER TABLE `aluni_anggota_dasar`
MODIFY `id_anggota` int(12) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=13;
--
...
--
ALTER TABLE `aluni_m_modul`
MODIFY `id_modul` int(3) unsigned zerofill NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=6;
--
...
--
-- AUTO_INCREMENT for table `aluni_program_keahlian`
--
ALTER TABLE `aluni_program_keahlian`
MODIFY `kode_pk` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=9;
